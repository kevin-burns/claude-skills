...
Measured 2026-09-02: a 70 KB evidence base returned **zero hits** across every on-premise,
network and identity term — and the coverage table marked every engagement untouched, because
three prior sessions had gone after positioning, career shape and leadership and never once at
the technical estates. The zero meant *nobody had asked*, not *he has not done it*. A cover
...
reporting a zero.** "Not covered" and "covered and absent" must never be reported the same
way.
...
Measured on one real CV, 2026-09-02: **27 of 62 skills entries appeared in zero roles, and
exactly one was genuinely stale.** All eight observability tools turned out to have real
engagements nobody had ever asked about. Two entries — Kafka and BigQuery — had already been
**cut** by an earlier session as unevidenced, and both were real work at the same employer. One
more was a single message away from the same fate.

Roughly one in twelve was padding. Treating the table row as a licence to cut would have deleted
the other eleven, and deleting evidence is not a recoverable edit: the person stops mentioning
what you told them they could not support.
