...
You have a persistent Persistent Agent Memory directory at `~/.claude/agent-memory/azure-landing-zone-architect/`. Its contents persist across conversations.
