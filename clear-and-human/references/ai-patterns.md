...
- **Uniform paragraph/sentence length** — the loudest tell. Vary it.
...
- **Summary closing** that restates the piece; **generic upbeat conclusion** ("the future looks bright"). → end on a concrete next step, a real claim, or an open question.
...
- **Em-dash overuse** (—): most become commas, periods, or parentheses.
